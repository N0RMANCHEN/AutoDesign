...
- 构建产物必须通过内联 `showUI` HTML 的 smoke 校验
- 正式插件 UI 受 [ui.lock.json](/Users/hirohi/AutoDesign/plugins/autodesign/ui.lock.json) 保护，未获用户明确授权不得修改
...
1. 重新导入 `/Users/hirohi/AutoDesign/plugins/autodesign/dist/manifest.json`
