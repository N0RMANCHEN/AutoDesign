...
export function inspectNodeSubtree(root: any, options?: { maxDepth?: number }) {
  ...
  const visit = (node: any, depth: number) => {
    ...
    inspected.push({
      ...
      layoutWrap: readStringProperty(node, "layoutWrap"),
      ...
      counterAxisSpacing: readNumericProperty(node, "counterAxisSpacing"),
      ...
      minWidth: readNumericProperty(node, "minWidth"),
      maxWidth: readNumericProperty(node, "maxWidth"),
      minHeight: readNumericProperty(node, "minHeight"),
      maxHeight: readNumericProperty(node, "maxHeight"),
      ...
      textAutoResize: readStringProperty(node, "textAutoResize"),
